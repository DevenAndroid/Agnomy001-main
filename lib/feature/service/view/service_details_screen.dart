...
class _ServiceDetailsScreenState extends State<ServiceDetailsScreen> {
        ...
        initState: (state) {
          if (widget.fromPage == "search_page") {
            ...
            Get.find<ServiceDetailsController>()
                .getServiceDetails(widget.serviceID, placedIdGloabal.value);
          }
        },
                                                        ...
                                                        Padding(
                                                          ...
                                                          child:
                                                            ...
                                                            children: [
                                                              ...
                                                              Text(
                                                                " ${service.providers!.length.toString()} Available",
                                                                style: ubuntuRegular.copyWith(
                                                                    fontSize:
                                                                    Dimensions
                                                                        .fontSizeExtraLarge,
                                                            ...
                                                            return Padding(
                                                              ...
                                                              child: GridView
                                                                ...
                                                                shrinkWrap:
                                                                    true,
                                                                scrollDirection:
                                                                    Axis.vertical, // Change this to Axis.horizontal if you want horizontal scrolling
                                                                itemCount: service
                                                                    .providers!
                                                                    .length,
                                                                gridDelegate:
                                                                            ...
                                                                            CircleAvatar(
                                                                              ...
                                                                              child: Container(
                                                                                ...
                                                                                child: ClipRRect(
                                                                                  ...
                                                                                  child: Image(
                                                                                    image: NetworkImage("${Get.find<SplashController>().configModel.content!.imageBaseUrl}/provider/logo/${service.providers![index].logo.toString()}"),
                                                                            ...
                                                                            Column(
                                                                              ...
                                                                              children: [
                                                                                ...
                                                                                Row(
                                                                                  ...
                                                                                  children: [
                                                                                    ...
                                                                                    Directionality(
                                                                                      ...
                                                                                      child: Text('${service.providers![index].ratingCount} ${'reviews'.tr}',
                                                                                          style: ubuntuRegular.copyWith(
                                                                                ...
                                                                                SizedBox(
                                                                                  ...
                                                                                  child: Text(
                                                                                    '${service.providers![index].city.toString()}, ${service.providers![index].state.toString()}',
                                                                                    style: ubuntuRegular.copyWith(
                                                                                      overflow: TextOverflow.ellipsis,
                                                                                      fontSize: Dimensions.fontSizeDefault,
                                                                                      color: Theme.of(context).secondaryHeaderColor,
  ...
  Future<void> createQuote() async {
    final String serviceId =
        serviceID.toString(); // widget.service!.id.toString();
    final String? categoryID =
        categoryId; //widget.service!.categoryId.toString();
    final String? subCategoryID =
        subCategoryId; //widget.service!.subCategoryId.toString();
    ...
    final request = http.MultipartRequest('POST', url)
      ...
      ..fields['category_id'] =
          categoryID.toString() //'33f46f95-e8c0-4e91-86fb-0819ba4adebc'
      ..fields['sub_category_id'] =
          subCategoryID.toString() //'eaa49fe9-ae1c-41de-862f-9753d7fa20da'
