...
class WebBookingDetailsScreen extends StatelessWidget {
  ...
  const WebBookingDetailsScreen({Key? key, this.tabController}) : super(key: key);
...
class BookingDetailsTopCard extends StatelessWidget {
  ...
  const BookingDetailsTopCard({Key? key, required this.bookingDetailsContent}) : super(key: key);
...
class WebBookingDetailsSection extends StatelessWidget {
  final BookingDetailsContent bookingDetailsContent;
  const WebBookingDetailsSection({Key? key, required this.bookingDetailsContent}) : super(key: key);
