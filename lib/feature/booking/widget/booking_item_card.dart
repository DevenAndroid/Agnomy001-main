...
class BookingItemCard extends StatelessWidget {
  ...
  const BookingItemCard(
      {Key? key, required this.bookingModel, required this.index})
      : super(key: key);
    ...
    return InkWell(
      ...
      child: Container(
        decoration: BoxDecoration(
            ...
            border:
                Border.all(color: Theme.of(context).hintColor.withOpacity(0.3)),
              ...
              Directionality(
                ...
                child: Text(
                  PriceConverter.convertPrice(
                      bookingModel.quoteOfferedPrice!.toDouble()),
                  style: ubuntuBold.copyWith(
                ...
                Text('Service Name : ',
                    style: ubuntuRegular.copyWith(
                        ...
                        color: Theme.of(context)
                            ...
                            .withOpacity(.6))),
                Text(
                    bookingModel.post != null
                        ? bookingModel.post!.serviceName! ?? ""
                        : "",
                    style: ubuntuRegular.copyWith(
                        fontSize: Dimensions.fontSizeSmall,
                        color: Theme.of(context)
            ...
            Row(
              children: [
                SizedBox(
                    height: 15,
                    width: 30,
                    child: Image.asset(Images.bscheduled)),
                Text(
                  DateConverter.localDateToIsoString(
                      DateTime.tryParse(bookingModel.serviceSchedule!)!),
                  style: ubuntuRegular.copyWith(
                    ...
                    ? GetBuilder<ServiceBookingController>(
                        ...
                        return InkWell(
                          ...
                          child: Container(
                            ...
                            child:
                                (serviceBookingController.selectedRebookIndex ==
                                            index &&
