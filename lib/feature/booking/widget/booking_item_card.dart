        ...
        child: Column(
          ...
          children: [
            ...
            Row( children: [
              ...
              Text(DateConverter.localDateToIsoString(DateTime.tryParse(bookingModel.serviceSchedule!)!),
                style: ubuntuRegular.copyWith(fontSize: Dimensions.fontSizeDefault,  color: Theme.of(context).textTheme.bodyLarge!.color!.withOpacity(.6)),
                textDirection: TextDirection.ltr,
              ),
            ],),
            ...
            Row( mainAxisAlignment: MainAxisAlignment.spaceBetween,  children: [
              ...
              Container(
                decoration: BoxDecoration(
                  ...
                  color: bookingStatus=="ongoing" ? Theme.of(context).colorScheme.primary.withOpacity(.5):
                  bookingStatus=="pending" ? Theme.of(context).colorScheme.primary.withOpacity(.2):
                  bookingStatus=="accepted" ? Theme.of(context).colorScheme.primary.withOpacity(.5):
                  ...
                  child: Center(
                    child: Text(bookingStatus.tr,
                      style:ubuntuMedium.copyWith(
                        ...
                        color: bookingStatus=="ongoing" ? Theme.of(context).colorScheme.tertiary:
                        bookingStatus=="pending" ? Get.isDarkMode ? Theme.of(context).secondaryHeaderColor :
                        Theme.of(context).colorScheme.primary :
                        bookingStatus=="accepted" ? Theme.of(context).colorScheme.tertiary:
                        bookingStatus=="completed" ? Colors.white: Theme.of(context).colorScheme.error,
                      ),
                    ),
                  ),
                ),
                ...
                builder: (serviceBookingController) {
                  return InkWell(
                    ...
                    child: Container(
                      ...
                      padding: const EdgeInsets.symmetric(vertical: Dimensions.paddingSizeTine, horizontal: Dimensions.paddingSizeSmall),
