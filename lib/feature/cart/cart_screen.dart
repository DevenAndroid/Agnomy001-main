  ...
  void initState() {
    ...
    Get.find<CartController>().getCartListFromServer().then((value) {
     ...
     Future.delayed(const Duration(milliseconds: 300)).then((value) {
       ...
       if(Get.find<CartController>().cartList.isNotEmpty && Get.find<CartController>().preSelectedProvider && Get.find<CartController>().cartList[0].provider !=null
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: SafeArea(child: GetBuilder<CartController>(builder: (cartController){
        ...
        if(cartController.cartList.isNotEmpty && cartController.preSelectedProvider &&  cartController.cartList[0].provider!= null && cartController.cartList[0].provider!.timeSchedule != null ){
                              ...
                              if(ResponsiveHelper.isWeb() && !ResponsiveHelper.isTab(context) && !ResponsiveHelper.isMobile(context))
                                ...
                                Padding(
                                  ...
                                  child: Column( children: [
                                    cartController.preSelectedProvider &&  cartController.cartList[0].provider!= null && cartController.cartList[0].provider!.timeSchedule != null ?
                                    Container(
