            ...
            child: Column(
              children: [
                ...
                Row(children: [
                  ...
                  SizedBox(
                    height: Get.find<LocalizationController>().isLtr?100:110,
                    width: Get.find<LocalizationController>().isLtr?100:110,
                    child: ClipRRect(
                      borderRadius: BorderRadius.circular(Dimensions.radiusDefault),
                      child: CustomImage(
                  ...
                  Expanded(
                    child: GridView.builder(
                      ...
                      gridDelegate: SliverGridDelegateWithFixedCrossAxisCount(
                        ...
                        mainAxisExtent: Get.find<LocalizationController>().isLtr? 240 : 255,
