...
//2031 Lower Sacramento Road, Lodi, CA, USA
...
class _ProductBottomSheetState extends State<ServiceCenterDialog1> {
  ...
  void addAllServiceIDs() {
    serviceProviderIDs = [];

    for (int i = 0; i < servicewiseProviderModel.value.content!.length; i++) {
      servicewiseProviderModel.value.content![i].value = 1;
    }

    serviceProviderIDs = servicewiseProviderModel.value.content!
  ...
  void addOneServiceIDs(int index) {
    if (!serviceProviderIDs!
      ...
      serviceProviderIDs!
          .add(servicewiseProviderModel.value.content![index].providerId);
    }
  }
  ...
  void removeAllServiceIDs() {
    serviceProviderIDs = [];
    for (int i = 0; i < servicewiseProviderModel.value.content!.length; i++) {
      servicewiseProviderModel.value.content![i].value = 0;
    }
  }
                      ...
                      if (widget.service!.variationsAppFormat!
                        ...
                        return Column(
                          ...
                          children: [
                            Row(
                              ...
                              children: [
                                ...
                                ClipRRect(
                                  ...
                                  child: CustomImage(
                                    image:
                                        '${Get.find<SplashController>().configModel.content!.imageBaseUrl!}/service/${widget.service!.thumbnail}',
                            ...
                            Text(
                              "${servicewiseProviderModel.value.content!.length == 0 ? 1 : servicewiseProviderModel.value.content!.length} ${'options_available'.tr}",
                                                                    ...
                                                                    Row(
                                                                      ...
                                                                      children: [
                                                                        Text(
                                                                          ...
                                                                          style:
                                                                              ubuntuMedium.copyWith(fontSize: Dimensions.fontSizeSmall),
                                                                          maxLines:
                                                                              2,
                                                                          overflow:
                                                                          ...
                                                                          child:
                                                                            ...
                                                                            children: [
                                                                              Row(
                                                                                ...
                                                                                children: [
                                                                                  Text(
                                                                                    servicewiseProviderModel.value.content![index].name.toString(),
                                                                                  ...
                                                                                  Spacer(),
                                                                                  Text(
                                                                                    '${servicewiseProviderModel.value.content![index].distance.toString()} miles away',
                                                                                    style: ubuntuMedium.copyWith(fontSize: Dimensions.fontSizeSmall),
                                                                                    maxLines: 2,
                                                                                    overflow: TextOverflow.ellipsis,
                                                                                  ),
  ...
  Future<void> createQuote() async {
    ...
    request.fields['provider'] = serviceProviderIDs != null
        ? jsonEncode(serviceProviderIDs)
        : jsonEncode(serviceProviderIDs);
    //'650c77e3-cdc1-46df-ba94-7769601c6462';
    ...
    try {
      ...
      if (response.statusCode == 200) {
        ...
        quote_id = responseData['content']['quote_id'];
