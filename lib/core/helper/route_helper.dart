...
import '../../feature/home/widget/bottom_create_post_dialog.dart';
...
class RouteHelper {
  ...
  static String getChatScreenRoute(
    ...
    return '$chatScreen?channelID=$channelId&name=$name&image=$image&phone=$phone&bookingID=$bookingID&userType=$userType&fromNotification=$fromNotification';
  }
